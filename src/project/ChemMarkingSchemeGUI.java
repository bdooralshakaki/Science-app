 ...
 * @author bdoor
 */
public class ChemMarkingSchemeGUI extends javax.swing.JFrame {

    /**
     * Creates new form ChemMarkingScheme
     */
    public ChemMarkingSchemeGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        titleLbl.setText("Chemistry Marking Scheme");
        getContentPane().add(titleLbl);
        titleLbl.setBounds(10, 40, 500, 47);
        ...
        backgroundLbl.setBounds(-330, -10, 900, 620);
    ...
    private void year14BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year14BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/markingscheme/6/6b1ad6b3-8ef5-4b30-b959-43f3f3468e5e/6b1ad6b3-8ef5-4b30-b959-43f3f3468e5e.pdf").toURI());
    ...
    private void year13BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year13BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/Marking_Schemes/2013/Leaving_Certificate/Chemistry/Higher/Paper/Paper%20.pdf").toURI());
    ...
    private void year12BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year12BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/Marking_Schemes/2012/Leaving_Certificate/Chemistry/Higher/Paper/Paper%20.pdf").toURI());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChemMarkingSchemeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChemMarkingSchemeGUI().setVisible(true);
            }
        });
    }
