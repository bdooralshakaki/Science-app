 ...
 * @author Gareth
 */
public class PhysicsQuestion1GUI extends javax.swing.JFrame {
    public String phyquestion1;
    public String phyanswer1;
    ...
    private void initComponents() {
        ...
        Chemistry.setText("Question 1 of 3");
        ...
        Question1.setText(" When light bends as it enters a different medium the process is known as what?");
        getContentPane().add(Question1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, 550, -1));
        ...
        getContentPane().add(CtdInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 440, 20));
        ...
        getContentPane().add(Clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 100, 80));
        ...
        getContentPane().add(AddBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 370, 100, 80));
        ...
        getContentPane().add(Display, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 370, 100, 80));
    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        PhysicsQuestion2GUI myPhysicsQuestion2GUI = new PhysicsQuestion2GUI();
        myPhysicsQuestion2GUI.setVisible(true);
        dispose();
    }//GEN-LAST:event_NextActionPerformed

    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed

        phyquestion1 = Question1.getText();
        phyanswer1 = AnswerTf.getText();

        //create a new QuestionCode
        QuestionCode q = new QuestionCode();

        //add Contents of textfields to q
        q.setphyquestion1(phyquestion1);
        q.setphyanswer1(phyanswer1);
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        ...
        for(int i = 0; i < aList.size();i++){
            JOptionPane.showMessageDialog(null, "Question: "+aList.get(i).getphyquestion1()+"\n Answer: "+aList.get(i).getphyanswer1());
        }
    ...
    private void loadFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadFileActionPerformed
        ...
        try{
            ...
            for(QuestionCode x:aList){
                JOptionPane.showMessageDialog(null, "Question: " + x.getphyquestion1()+ "   Answer: " + x.getphyanswer1());
            }
            oStream.close();
        }
        catch(IOException e){
