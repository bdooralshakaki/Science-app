 ...
 * @author bdoor
 */
public class PhysicsExamPaperGUI extends javax.swing.JFrame {

    /**
     * Creates new form PhysicsExamPaper
     */
    public PhysicsExamPaperGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        titleLbl.setText("Physics Exam papers");
        getContentPane().add(titleLbl);
        titleLbl.setBounds(60, 40, 363, 47);
        ...
        year14Btn.setBounds(180, 170, 190, 50);
        ...
        year13Btn.setBounds(180, 260, 190, 50);
        ...
        backBtn.setBounds(60, 460, 90, 40);
        ...
        jLabel1.setBounds(-330, -70, 840, 620);
    ...
    private void year14BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year14BtnActionPerformed
       ...
       try
        { 
            Desktop.getDesktop().browse(new URL("http://www.examinations.ie/archive/exampapers/2014/LC021ALP000EV.pdf").toURI());
    ...
    private void year13BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year13BtnActionPerformed
        ...
        try
        { 
            Desktop.getDesktop().browse(new URL("http://www.examinations.ie/archive/exampapers/2013/LC021ALP000EV.pdf").toURI());
    ...
    private void year12BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year12BtnActionPerformed
        // TODO add your handling code here:
         try
        { 
            Desktop.getDesktop().browse(new URL("http://www.examinations.ie/archive/exampapers/2012/LC021ALP000EV.pdf").toURI());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhysicsExamPaperGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhysicsExamPaperGUI().setVisible(true);
            }
        });
    }
