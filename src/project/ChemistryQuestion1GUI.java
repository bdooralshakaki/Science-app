 ...
 * @author Gareth
 */
public class ChemistryQuestion1GUI extends javax.swing.JFrame {
    public String chemquestionText1;
    public String chemAnswer1;
    private ArrayList<QuestionCode> aList;
    /**
     * Creates new form ChemistryQuestion1
     */
    public ChemistryQuestion1GUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Chemistry.setText("Question 1 of 5");
        ...
        Question1.setText("What is the first element on the periodic table?");
        getContentPane().add(Question1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 450, -1));
        ...
        Quiz1.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        Quiz1.setText("Quiz");
        getContentPane().add(Quiz1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, -1, -1));
        ...
        getContentPane().add(Bground, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 500, 570));
    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        ChemistryQuestion2GUI myChemistryQuestion2 = new ChemistryQuestion2GUI();
        myChemistryQuestion2.setVisible(true);
        dispose();
    }//GEN-LAST:event_NextActionPerformed

    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed
        
        chemquestionText1 = Question1.getText();
        chemAnswer1 = AnswerTf.getText();

        //create a new QuestionCode
        QuestionCode q = new QuestionCode();

        //add Contents of textfields to q
        q.setChemquestionText1(chemquestionText1);
        q.setchemAnswer1(chemAnswer1);
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        ...
        for(int i = 0; i < aList.size();i++){
            JOptionPane.showMessageDialog(null, "Question: "+aList.get(i).getchemquestionText1()+"\n Answer: "+aList.get(i).getchemAnswer1());
        }
    ...
    private void SaveFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveFileActionPerformed
        ...
        String chemquestionText1, chemAnswer1;
    ...
    private void loadFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadFileActionPerformed
        ...
        try{
            ...
            for(QuestionCode x:aList){
                JOptionPane.showMessageDialog(null, "Question: " + x.getchemquestionText1()+ "   Answer: " + x.getchemAnswer1());
            }
            oStream.close();
        }
        catch(IOException e){
