 ...
 * @author bdoor
 */
public class JuniorCertExampapersGUI extends javax.swing.JFrame {

    /**
     * Creates new form JuniorCertExampapers
     */
    public JuniorCertExampapersGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        yearLbl.setBounds(30, 130, 130, 22);
        ...
        backgroundLbl.setBounds(-330, -10, 920, 580);
    ...
    private void year14BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year14BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/Exam_Papers/2014/Junior_Certificate/Science_/Higher/Paper/Paper%20.pdf").toURI());
    ...
    private void year13BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year13BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/exam_papers/2013/junior_certificate/science_revised_syllabus/higher/paper/paper.pdf").toURI());
    ...
    private void year12BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year12BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/exam_papers/2012/junior_certificate/science_revised_syllabus/higher/paper/paper.pdf").toURI());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JuniorCertExampapersGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JuniorCertExampapersGUI().setVisible(true);
            }
        });
    }
