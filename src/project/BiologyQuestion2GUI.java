 ...
 * @author x14428778
 */
public class BiologyQuestion2GUI extends javax.swing.JFrame {
    private String questionText2;
    private String answer2;
    private ArrayList<QuestionCode> aList;

    /**
     * Creates new form BiologyQuestion2
     */
    public BiologyQuestion2GUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Biology.setText("Question 2 of 5");
        ...
        Question2.setText("A single piece of coiled DNA is known as a?");
        getContentPane().add(Question2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 270, 270, -1));
        getContentPane().add(AnswerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, 230, -1));

        Next.setText("Next");
        Next.setMaximumSize(new java.awt.Dimension(83, 23));
        Next.setMinimumSize(new java.awt.Dimension(83, 23));
        ...
        getContentPane().add(CtdInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 380, 440, 20));
        ...
        getContentPane().add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 400, 100, 80));
        ...
        getContentPane().add(SaveFile, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 490, -1, -1));
        ...
        getContentPane().add(loadFile, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 490, -1, -1));
    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        ...
        BiologyQuestion3GUI myBiologyQuestion3 = new BiologyQuestion3GUI();
        myBiologyQuestion3.setVisible(true);
        dispose();
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        ...
        for(int i = 0; i < aList.size();i++){
          JOptionPane.showMessageDialog(null, "Question: "+aList.get(i).getQuestionText2()+"\n Answer: "+aList.get(i).getAnswer2());
        }
    }//GEN-LAST:event_DisplayActionPerformed

    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
       questionText2 = Question2.getText();
       answer2 = AnswerTf.getText();
    ...
    private void loadFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadFileActionPerformed
        ...
        try{
            ...
            for(QuestionCode x:aList){
                JOptionPane.showMessageDialog(null, "Question: " + x.getQuestionText2()+ "   Answer: " + x.getAnswer2());
            }
            oStream.close();
        }
        catch(IOException e){
