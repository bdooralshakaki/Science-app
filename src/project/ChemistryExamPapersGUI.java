 ...
 * @author bdoor
 */
public class ChemistryExamPapersGUI extends javax.swing.JFrame {

    /**
     * Creates new form ChemistryExamPapers
     */
    public ChemistryExamPapersGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        titleLbl.setText("Chemistry Exam papers");
        getContentPane().add(titleLbl);
        titleLbl.setBounds(50, 30, 416, 47);
        ...
        backgroundLbl.setBounds(-350, -50, 860, 600);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChemistryExamPapersGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChemistryExamPapersGUI().setVisible(true);
            }
        });
    }
