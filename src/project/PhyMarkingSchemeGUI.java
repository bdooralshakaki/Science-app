 ...
 * @author bdoor
 */
public class PhyMarkingSchemeGUI extends javax.swing.JFrame {

    /**
     * Creates new form PhyMarkingScheme
     */
    public PhyMarkingSchemeGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        titleLbl.setText("Physics Marking Scheme");
        getContentPane().add(titleLbl);
        titleLbl.setBounds(40, 40, 500, 47);
        ...
        backgroundLbl.setBounds(-310, -20, 850, 610);
    ...
    private void year14BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year14BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/markingscheme/3/32fe27e9-54a3-4b50-8098-8c99fd283fc3/32fe27e9-54a3-4b50-8098-8c99fd283fc3.pdf").toURI());
    ...
    private void year13BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year13BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/Marking_Schemes/2013/Leaving_Certificate/Physics/Higher/Paper/Paper%20.pdf").toURI());
    ...
    private void year12BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_year12BtnActionPerformed
        ...
        try
        {
            Desktop.getDesktop().browse(new URL("https://www.studyclix.ie/Content/Marking_Schemes/2012/Leaving_Certificate/Physics/Higher/Paper/Paper%20.pdf").toURI());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhyMarkingSchemeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhyMarkingSchemeGUI().setVisible(true);
            }
        });
    }
