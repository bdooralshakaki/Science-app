 ...
 * @author Gareth
 */
public class ChemistryQuestion5GUI extends javax.swing.JFrame {
    public String chemquestionText5;
    public String chemAnswer5;
    private ArrayList<QuestionCode> aList;

    /**
     * Creates new form ChemistryQuestion5
     */
    public ChemistryQuestion5GUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Chemistry.setText("Question 5 of 5");
        ...
        Question5.setText("What is the centre of an atom called?");
        getContentPane().add(Question5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 450, -1));
    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
            ChemistrySummary myChemistrySummary = new ChemistrySummary();
            myChemistrySummary.setVisible(true);
            dispose();
    }//GEN-LAST:event_NextActionPerformed

    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed

        chemquestionText5 = Question5.getText();
        chemAnswer5 = AnswerTf.getText();

        //create a new QuestionCode
        QuestionCode q = new QuestionCode();

        //add Contents of textfields to q
        q.setchemquestionText5(chemquestionText5);
        q.setchemAnswer5(chemAnswer5);
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        ...
        for(int i = 0; i < aList.size();i++){
            JOptionPane.showMessageDialog(null, "Question: "+aList.get(i).getchemquestionText5()+"\n Answer: "+aList.get(i).getchemAnswer5());
        }
    ...
    private void SaveFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveFileActionPerformed
        ...
        String chemquestionText5, chemAnswer5;
    ...
    private void loadFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadFileActionPerformed
        ...
        try{
            ...
            for(QuestionCode x:aList){
                JOptionPane.showMessageDialog(null, "Question: " + x.getchemquestionText5()+ "   Answer: " + x.getchemAnswer5());
            }
            oStream.close();
        }
        catch(IOException e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChemistryQuestion5GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChemistryQuestion5GUI().setVisible(true);
            }
        });
    }
