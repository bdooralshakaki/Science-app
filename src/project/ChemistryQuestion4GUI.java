 ...
 * @author Gareth
 */
public class ChemistryQuestion4GUI extends javax.swing.JFrame {
    public String chemquestionText4;
    public String chemAnswer4;
    private ArrayList<QuestionCode> aList;

    /**
     * Creates new form ChemistryQuestion4
     */
    public ChemistryQuestion4GUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Chemistry.setText("Question 4 of 5");
        ...
        Question4.setText("What is the main gas found in the air we breathe?");
        getContentPane().add(Question4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 450, -1));
        ...
        getContentPane().add(CtdInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 440, 20));
    ...
    private void NextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextActionPerformed
        ChemistryQuestion5GUI myChemistryQuestion5 = new ChemistryQuestion5GUI();
        myChemistryQuestion5.setVisible(true);
        dispose();
    }//GEN-LAST:event_NextActionPerformed

    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed

        chemquestionText4 = Question4.getText();
        chemAnswer4 = AnswerTf.getText();

        //create a new QuestionCode
        QuestionCode q = new QuestionCode();

        //add Contents of textfields to q
        q.setchemquestionText4(chemquestionText4);
        q.setchemAnswer4(chemAnswer4);
    ...
    private void DisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayActionPerformed
        ...
        for(int i = 0; i < aList.size();i++){
            JOptionPane.showMessageDialog(null, "Question: "+aList.get(i).getchemquestionText4()+"\n Answer: "+aList.get(i).getchemAnswer4());
        }
    ...
    private void SaveFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveFileActionPerformed
        ...
        String chemquestionText4, chemAnswer4;
    ...
    private void loadFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadFileActionPerformed
        ...
        try{
            ...
            for(QuestionCode x:aList){
                JOptionPane.showMessageDialog(null, "Question: " + x.getchemquestionText4()+ "   Answer: " + x.getchemAnswer4());
            }
            oStream.close();
        }
        catch(IOException e){
